/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: 7a52fbb025c8a97881482cfe17c3016f)
// Runtime types generated with workerd@1.20260617.1 2026-06-20 nodejs_compat
interface __BaseEnv_Env {
	AI: Ai;
	SHRIMP_MODEL: "@cf/zai-org/glm-4.7-flash";
	SHRIMP_OWNER: "user";
	SHRIMP_MAX_ITERATIONS: "6";
	SHRIMP_FREE_MODE: "true";
	SHRIMP_AGENT: DurableObjectNamespace<import("./index").ShrimpAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "ShrimpAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SHRIMP_MODEL" | "SHRIMP_OWNER" | "SHRIMP_MAX_ITERATIONS" | "SHRIMP_FREE_MODE">> {}
}
